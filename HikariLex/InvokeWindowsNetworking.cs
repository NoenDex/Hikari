...
namespace HikariLex
{
    class InvokeWindowsNetworking
    {
        ...
        private static ErrorClass[] ERROR_LIST = new ErrorClass[] {
            new ErrorClass(NO_ERROR, "Success: Operation Completed"),
        ...
        {
            return connectToRemote(localDrive, remoteUNC, null, null, false);
        }

        public static string connectToRemote(string localDrive, string remoteUNC, string username, string password)
        {
            return connectToRemote(localDrive, remoteUNC, username, password, false);
        }

        public static string connectToRemote(string localDrive, string remoteUNC, string username, string password, bool promptUser)
        {
